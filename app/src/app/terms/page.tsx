    ...
    <>
      ...
      <div className="mt-2 bg-gray-100">
        <div className="mx-20 py-10">
            ...
            computer. Cookies are uniquely assigned to you and can only be read by
            ...
            cookies do not require your consent as they are always enabled. Please
            keep in mind that by accepting required Cookies, you also accept
            third-party Cookies, which might be used via third-party services
            provided on our website – for example, a video display window provided
            by third parties and integrated into our website.
            </p>
            <br />
            <p>
